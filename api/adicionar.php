...
// Extrai o campo "titulo" do array recebido e aplica uma proteção contra SQL Injection, escapando caracteres perigosos.
...
// Retorna para o JavaScript um objeto JSON com os dados da tarefa recém-criada: o ID gerado automaticamente (insert_id),
